...
module.exports = {
     ...
     */
    botname: process.env.BotName || "sithuwa",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 Sithuwa 𝐁𝐨𝐭",
     ...
     */
    ownername: process.env.Owner_Name || "Sithuwa",
    ownernumber: process.env.Owner_Number || "94776435240",
